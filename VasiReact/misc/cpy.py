...
def add_text(image_path: str, dialog_text: str) -> int:
    ...
    temp_two = cv2.resize(temp_img, (1600, 840))
    print(temp_img.shape)
    temp_tri = temp_two[5: 835, 250: 1355]
...
#     ["grok_sample2.jpg", "THE SHADOW STRIKES SILENTLY, UNLEASHING A CASCADE OF CHAOS ON THE UNWARY."],
#     ["grok_sample3.jpg", "WITH THE MIGHT OF THE STARS, THE HERO RISES TO DEFY THE ODDS."],
#     ["grok_sample2.jpg", "AN UNEXPECTED ALLIANCE IS FORMED UNDER THE SILVER GLEAM OF THE MOON."],
#     ["grok_sample3.jpg", "THE VILLAIN LAUGHS, NAIVELY THINKING DEFEAT IS UNAVOIDABLE."],
#     ["grok_sample2.jpg", "A WHISPER OF HOPE ECHOES BRIEFLY THROUGH THE STARLIT NIGHT."],
#     ["grok_sample3.jpg", "IN THE FINAL MOMENT, DESTINY IS REWRITTEN WITH UNYIELDING COURAGE."]
# ])
